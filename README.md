# MediaScope Lower Thirds -- Lower Thirds Orchestration for OBS Studio

![Version](https://img.shields.io/github/v/release/media-scope/mediascope-lower-thirds)
...
**MediaScope Lower Thirds** is a professional lower-third orchestration engine for OBS
...
MediaScope Lower Thirds treats lower thirds as timed visual elements in a controlled
flow:
...
GNU GPL v2. This build is a self-contained fork maintained for MediaScope
Production's internal OBS setup -- no remote marketplace, telemetry, or
outbound links are included.

------------------------------------------------------------------------

### MediaScope Production

Broadcast-grade lower thirds for MediaScope's live streaming, video
production, and event coverage work.
