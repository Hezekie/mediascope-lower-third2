...
inline constexpr const char *sltBrowserSourceName = "MediaScope Lower Thirds Source";
...
inline constexpr const char *sltDockTitle = "MediaScope Lower Thirds Controller";
...
// Built-in style gallery (see core.cpp for the full list of presets).
